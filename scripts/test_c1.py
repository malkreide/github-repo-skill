...
ORDER_CASES = [
    ...
    (
        "echt falsch sortiert (Security vor Contributing)",
        "en",
        True,
        "# t\n## Security\nx\n## Contributing\nx\n## License\nx\n## Author\nx\n",
    ),
    ...
    (
        "Duplikat + Schlussblock echt falsch sortiert",
        "en",
        True,
        "# t\n## Data License\nx\n## Security\nx\n## Contributing\nx\n"
        "## License\nx\n## Author\nx\n",
    ...
    (
        "Schlussblock durchgehend h3, falsch sortiert",
        "en",
        True,
        "# t\n### Security\nx\n### Contributing\nx\n### License\nx\n### Author\nx\n",
    ),
    ...
    (
        "swisstopo-Muster: '## Security & Compliance' als Inhaltssektion",
        "en",
        False,
        "# t\n## Security & Compliance\nx\n## Contributing\nx\n## Security\nx\n"
        "## License\nx\n## Author\nx\n",
    ...
    (
        "register-Muster: '### Security' als Unterpunkt",
        "en",
        False,
        "# t\n## Safety & Limits\nx\n### Security\nx\n## Contributing\nx\n"
        "## Security\nx\n## License\nx\n## Author\nx\n",
    ...
    (
        "'### Security' als Unterpunkt, ohne späteres '## Security'",
        "en",
        False,
        "# t\n## Safety & Limits\nx\n### Security\nx\n## Contributing\nx\n"
        "## License\nx\n## Author\nx\n",
    ...
    (
        "seco-Muster: '## Data License' als Inhaltssektion",
        "en",
        False,
        "# t\n## Data License\nx\n## Contributing\nx\n## Security\nx\n"
        "## License\nx\n## Author\nx\n",
    ...
    (
        "DE seco-Muster: '## Datenlizenz' vorne",
        "de",
        False,
        "# t\n## Datenlizenz\nx\n## Mitwirken\nx\n## Sicherheit\nx\n"
        "## Lizenz\nx\n## Autor\nx\n",
    ...
    (
        "Schlussblock durchgehend h3, korrekt",
        "en",
        False,
        "# t\n### Contributing\nx\n### Security\nx\n### License\nx\n### Author\nx\n",
    ),
    ...
    (
        "D2: '## Security & Compliance' ALS Schluss-Sektion",
        "en",
        False,
        "# t\n## Contributing\nx\n## Security & Compliance\nx\n"
        "## License\nx\n## Author\nx\n",
...
EXIST_CASES = [
    (
        "h3-Schlussblock gilt als vorhanden",
        "en",
        0,
        "# t\n### Contributing\nx\n### Security\nx\n### License\nx\n### Author\nx\n",
    ),
    (
        "echt fehlende Sektionen werden gemeldet",
        "en",
        2,
        "# t\n## Contributing\nx\n## License\nx\n",
...
def test_c1_missing_is_level_blind():
    ...
    for name, lang, want_n, md in EXIST_CASES:
        ...
        if len(got) != want_n:
            bad.append(
                f"{name}: erwartet {want_n} 'fehlt'-Meldungen, "
